...
--ülkesi ingiltere olmayıp adı a ile baslayıp soy adı l ile biten 1985 öncesi dogumluların oncesinin listesi
...
--Stokta bulunan kaç tane urunumuz vardır?
...
--Kac ulkeden müşterimiz bulunmaktadır?
...
--SUM YAPISI
-- FONKSİYONA PARAMETRE OLARAK GONDERILEN KOLON İCERİGİNDEKİ TÜM DEĞERLERİ TOPLAYIP SİZE GERİ DÖNDÜRÜR
--TOPLAYIP SİZE GERİ DÖNDÜRÜR..


--Her bir üründen bir adet alsam ne kadar öderim
select SUM(UnitPrice) from Products


--Depoda Ucret Bazlı olarak toplam nekdarlık urunum kalmıstır?
select SUM(UnitPrice*UnitsInStock) from Products


--1997 yılında alınmış olan siparislerim icin toplam ne kadarlık kargo odemesi yaptık?
